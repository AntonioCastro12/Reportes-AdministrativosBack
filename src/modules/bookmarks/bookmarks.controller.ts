...
import {
	...
	ListHistoricReportResponse,
} from "./model/favorites.response";
...
export class BookmarksController {
	...
	@Post("favorites")
	@Roles(
		"tienda,staff-menudeo,staff-mayoreo,staff-inventarios-ost,sistemas,staff-planeacion,staff-marketing,staff-ingresos,staff-kipon"
	)
	@ApiOperation({
	...
	createFavorite(
		@Body(new ValidationPipe()) data: CreateFavoriteDTO,
		@Request() req: any
	) {
	...
	deleteFavorite(
		@Body(new ValidationPipe()) data: DeleteFavoriteDTO,
		@Request() req: any
	) {
