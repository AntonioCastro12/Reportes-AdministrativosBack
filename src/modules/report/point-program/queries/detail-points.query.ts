...
SELECT
	--A.CUST_ID
	A.CARD_NUM AS 'NUM SOCIO'
	,ISNULL(A.SORT_NAME,'N/A') AS 'NOM CORTO'
	,(A.FIRST_NAME + ' ' + A.LAST_NAME) AS 'NOMBRE SOCIO'
	,A.CST_CLASS_ID AS 'NIVEL'
	,B.NUM_PTS AS 'PUNTOS OTROGADOS'
	,B.RTL_LOC_ID AS 'TIENDA'
	,B.RTL_TRANS_SEQ AS 'TRANSACCION'
	,B.RTL_WKSTN_ID AS 'CAJA'
	,B.CREATE_DATE AS 'FECHA ACTIVIDAD'
